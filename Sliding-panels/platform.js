            ...
            O("auth", {
                callback: function() {
                    ...
                    a.checkSessionState(e, function(b) {
                        ...
                        if (d = d != b) jb("isLoggedIn", b), tb(), uc(), b || ((b = a.signOut) ? b() : (b = a.setToken) && b(null));
                        b =
                            ob();
                        ...
                        jb("savedUserState", c);
                        (d || f) && pb(b) && !S("disableRealtimeCallback") && a._pimf(b, !0)
                    })
                }
            });
            return !0
...
gapi.load("", {
    ...
    _c: {
        "jsl": {
            ...
            "h": "m;/_/scs/apps-static/_/js/k=oz.gapi.en.ordaRf6SlNg.O/m=__features__/am=AQ/rt=j/d=1/rs=AGLTcCONVJWFzwBqbeL2S7YRFeRMS24Rmg",
